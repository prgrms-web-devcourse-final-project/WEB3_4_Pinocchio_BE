...
import sns.pinocchio.config.global.auth.exception.email.MailErrorCode;
import sns.pinocchio.config.global.auth.exception.email.MailException;
...
public class EmailUtil {
    ...
    public static void sendEmail(String toEmail, String temporaryPassword) {
        try {
            ...
            // 본문 설정
            String body = "귀하의 임시 비밀번호는 " + temporaryPassword + " 입니다.\n" +
